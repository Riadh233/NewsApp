...
public class ScienceFragment extends Fragment implements LoaderManager.LoaderCallbacks<ArrayList<Article>> {
    ...
    private String SCIENCE_URL = "https://content.guardianapis.com/search";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvScience = rootView.findViewById(R.id.rv_science);
        loadingIndicator = rootView.findViewById(R.id.progress_indicator_science);
        emptyText = rootView.findViewById(R.id.empty_text_science);
        noInternetImage = rootView.findViewById(R.id.no_internet_science);
    ...
    public Loader<ArrayList<Article>> onCreateLoader(int id, Bundle args) {
        Uri baseUri = Uri.parse(SCIENCE_URL);
        ...
        uriBuilder.appendQueryParameter("page", String.valueOf(Constants.PAGE_NUMBER_SCIENCE));
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_previous && Constants.PAGE_NUMBER_SCIENCE > 1) {
            --Constants.PAGE_NUMBER_SCIENCE;
            getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, new ScienceFragment()).commit();
            Toast.makeText(getContext(), R.string.page_previous, Toast.LENGTH_SHORT).show();
            return true;
        } else if (id == R.id.nav_next && Constants.PAGE_NUMBER_SCIENCE <= Constants.TOTAL_PAGES_SCIENCE) {
            ++Constants.PAGE_NUMBER_SCIENCE;
            getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, new ScienceFragment()).commit();
